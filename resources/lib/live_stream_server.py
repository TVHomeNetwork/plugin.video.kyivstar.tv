...
class LiveStreamServer(object):
    ...
    def start(self):
        try:
            ...
            xbmc.log("KyivstarLiveStreamServer: started at 0.0.0.0:%s" % port, xbmc.LOGINFO)
        except Exception as e:
            xbmc.log("KyivstarLiveStreamServer exception %s" % str(e), xbmc.LOGERROR)
    ...
    def stop(self):
        ...
        xbmc.log("KyivstarLiveStreamServer: stoped", xbmc.LOGINFO)
